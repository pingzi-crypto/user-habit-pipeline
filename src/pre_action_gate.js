...
exports.buildMemoryConflictDecision = buildMemoryConflictDecision;
...
function normalizeExternalMemorySignal(externalMemorySignal) {
...
function buildMemoryConflictDecision(preActionDecision, externalMemorySignal) {
