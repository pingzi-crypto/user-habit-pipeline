...
exports.validateHabitRules = validateHabitRules;
...
function validateRule(rule, index) {
    ...
    if (Object.prototype.hasOwnProperty.call(candidate, "match_type") &&
    ...
    if (Object.prototype.hasOwnProperty.call(candidate, "preferred_terms") &&
        !isStringArray(candidate.preferred_terms)) {
        throw new Error(`${prefix}: "preferred_terms" must be an array of strings when provided.`);
    }
    if (Object.prototype.hasOwnProperty.call(candidate, "disambiguation_hints") &&
    ...
    if (Object.prototype.hasOwnProperty.call(candidate, "notes") &&
        !isStringArray(candidate.notes)) {
        throw new Error(`${prefix}: "notes" must be an array of strings when provided.`);
    }
    if (Object.prototype.hasOwnProperty.call(candidate, "clarify_below") &&
