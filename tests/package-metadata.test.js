...
test("package metadata documents the expected engine and packaged files", () => {
  ...
  assert.ok(pkg.files.includes("docs/integration-quickstart.md"));
  assert.ok(pkg.files.includes("docs/confidence-scoring.md"));
  assert.ok(pkg.files.includes("docs/local-memory-conflict-boundary.md"));
  ...
  assert.ok(pkg.files.includes("docs/codex-skill-integration.md"));
